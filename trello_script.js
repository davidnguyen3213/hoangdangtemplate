function insertCards(cards){
  ...
  //  sSample.getRange('J'+feed.getRow()).setValue(temptags);
   ...
   SpreadsheetApp.getActive().getSheetByName('Imported').appendRow([card.title,fdate,card.thumb,'=image("'+card.thumb+'",1)',user,domain+handler, bitly(domain+handler,RebrandAPI),card.id]); 
   return card;
